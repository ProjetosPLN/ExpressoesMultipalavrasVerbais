...
Na pasta dataset está contido o [dataset](https://github.com/ProjetosPLN/ExpressoesMultipalavrasVerbais/tree/master/dataset). Na pasta [scripts](https://github.com/ProjetosPLN/ExpressoesMultipalavrasVerbais/tree/master/scripts) está o script usado para ajuste fino dos modelos nas extensões .py (python 3) e ipynb (colab). O script do ajuste fino é uma adaptação [desse script](https://github.com/huggingface/transformers/blob/62ba3b6b43975e759851336b566852252be00669/examples/pytorch/text-classification/run_glue.py) do hugging face.
